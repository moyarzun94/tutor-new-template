...
import { ACCORDION_COLOR, CORRECT_ANSWER_COLOR, INCORRECT_ANSWER_COLOR, BACKGROUND_COLOR_ACCORDION, INPUT, DRAG_FIXED_TWO } from '../../../types'
          ...
          exercise.steps.map((step, index) => (
            <AccordionItem
              ...
              <AccordionButton
                ...
                bg={color[index] === ACCORDION_COLOR ? ACCORDION_COLOR : color[index] === CORRECT_ANSWER_COLOR ? CORRECT_ANSWER_COLOR : INCORRECT_ANSWER_COLOR}>
                <Box className={listBox[index]} flex="1" p={4} textAlign="left">
                  <AccordionAnswer nStep={step.n_step} text={step.left_text} stepType={step.type} inputLabels={step.input_labels} answer={stepCorrect[index]} />
                </Box>
                <AccordionIcon />
              </AccordionButton>
              <AccordionPanel
