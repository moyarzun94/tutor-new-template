...
export function Tutor({ id, setIntro, intro }) {
  ...
  return (
    <>
      {exerciseSelected && (
        <>
          <Stack textAlign="center" fontSize={{ base: '15px', sm: '20px', lg: '25px' }} className="eq-exercise">
          ...
          <Stack marginTop="20px">
            <AccordionSteps intro={intro} setIntro={setIntro} exercise={exerciseSelected} setNextExercise={setNextExercise} />
            {nextExercise && (
              <>
                <div>hola</div>
              </>
